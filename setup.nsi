; NSIS script for Radar Explorer Toolkit installer

; Set the name, version, and output path of the installer
!define LICENSE_FILE "LICENSE"
!define PRODUCT_NAME "Radar Explorer Toolkit"
!define /file PRODUCT_VERSION "installer\VERSION"
!define OUTFILE_NAME "Radar-Explorer-Toolkit-Installer-windows.exe"
...
Function CreateDesktopShortCut
  CreateShortCut "$desktop\${PRODUCT_NAME}.lnk" "$INSTDIR\Radar Explorer Toolkit.exe"
FunctionEnd

!define MUI_FINISHPAGE_RUN "$INSTDIR\Radar Explorer Toolkit.exe"
...
Section "${PRODUCT_NAME}" SEC01
  ...
  ; Copy the files from the dist\radar_explorer_toolkit directory
  ; File /r /oname=ignore "dist\radar_explorer_toolkit\*"
  File /r "dist\radar_explorer_toolkit\*"
...
Icon "dist\radar_explorer_toolkit\_internal\assets\splash_icon.ico"
